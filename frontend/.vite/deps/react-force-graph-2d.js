...
function exponential(a2, b, y2) {
  return a2 = Math.pow(a2, y2), b = Math.pow(b, y2) - a2, y2 = 1 / y2, function(t5) {
    return Math.pow(a2 + t5 * b, y2);
  };
}
function hue(a2, b) {
  var d2 = b - a2;
...
function zoom_default2() {
  ...
  function schedule(transition2, transform3, point2, event) {
    transition2.on("start.zoom", function() {
      ...
      var that = this, args = arguments, g2 = gesture(that, args).event(event), e3 = extent2.apply(that, args), p2 = point2 == null ? centroid(e3) : typeof point2 === "function" ? point2.apply(that, args) : point2, w2 = Math.max(e3[1][0] - e3[0][0], e3[1][1] - e3[0][1]), a2 = that.__zoom, b = typeof transform3 === "function" ? transform3.apply(that, args) : transform3, i2 = interpolate(a2.invert(p2).concat(w2 / a2.k), b.invert(p2).concat(w2 / b.k));
      return function(t5) {
        if (t5 === 1) t5 = b;
        else {
...
function P(n2, l2, u2, t5, i2, r2, o2, e3, f2, c4, s2) {
  var a2, h2, y2, d2, w2, g2, _2, m2 = t5 && t5.__k || v, b = l2.length;
  for (f2 = A2(u2, l2, m2, f2, b), a2 = 0; a2 < b; a2++) null != (y2 = u2.__k[a2]) && (h2 = -1 != y2.__i && m2[y2.__i] || p, y2.__i = a2, g2 = z(n2, y2, h2, i2, r2, o2, e3, f2, c4, s2), d2 = y2.__e, y2.ref && h2.ref != y2.ref && (h2.ref && D2(h2.ref, null, y2), s2.push(y2.ref, y2.__c || d2, y2)), null == w2 && null != d2 && (w2 = d2), (_2 = !!(4 & y2.__u)) || h2.__k === y2.__k ? f2 = H(y2, f2, n2, _2) : "function" == typeof y2.type && void 0 !== g2 ? f2 = g2 : d2 && (f2 = d2.nextSibling), y2.__u &= -7);
  return u2.__e = w2, f2;
}
function A2(n2, l2, u2, t5, i2) {
  var r2, o2, e3, f2, c4, s2 = u2.length, a2 = s2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++) null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? ("string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? o2 = n2.__k[r2] = m(null, o2, null, null, null) : d(o2) ? o2 = n2.__k[r2] = m(k, { children: o2 }, null, null, null) : void 0 === o2.constructor && o2.__b > 0 ? o2 = n2.__k[r2] = m(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : n2.__k[r2] = o2, f2 = r2 + h2, o2.__ = n2, o2.__b = n2.__b + 1, e3 = null, -1 != (c4 = o2.__i = T(o2, u2, f2, a2)) && (a2--, (e3 = u2[c4]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c4 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c4 != f2 && (c4 == f2 - 1 ? h2-- : c4 == f2 + 1 ? h2++ : (c4 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (a2) for (r2 = 0; r2 < s2; r2++) null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t5 && (t5 = S(e3)), E2(e3, e3));
  return t5;
}
...
function T(n2, l2, u2, t5) {
  var i2, r2, o2, e3 = n2.key, f2 = n2.type, c4 = l2[u2], s2 = null != c4 && 0 == (2 & c4.__u);
  if (null === c4 && null == e3 || s2 && e3 == c4.key && f2 == c4.type) return u2;
  if (t5 > (s2 ? 1 : 0)) {
...
function z(n2, u2, t5, i2, r2, o2, e3, f2, c4, s2) {
  var a2, h2, p2, y2, _2, m2, b, S2, C3, M2, $2, I2, A3, H2, L, T2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t5.__u && (c4 = !!(32 & t5.__u), o2 = [f2 = u2.__e = t5.__e]), (a2 = l.__b) && a2(u2);
  n: if ("function" == typeof T2) try {
    if (S2 = u2.props, C3 = "prototype" in T2 && T2.prototype.render, M2 = (a2 = T2.contextType) && i2[a2.__c], $2 = a2 ? M2 ? M2.props.value : a2.__ : i2, t5.__c ? b = (h2 = u2.__c = t5.__c).__ = h2.__E : (C3 ? u2.__c = h2 = new T2(S2, $2) : (u2.__c = h2 = new x(S2, $2), h2.constructor = T2, h2.render = G), M2 && M2.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), C3 && null == h2.__s && (h2.__s = h2.state), C3 && null != T2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = w({}, h2.__s)), w(h2.__s, T2.getDerivedStateFromProps(S2, h2.__s))), y2 = h2.props, _2 = h2.state, h2.__v = u2, p2) C3 && null == T2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), C3 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
      if (C3 && null == T2.getDerivedStateFromProps && S2 !== y2 && null != h2.componentWillReceiveProps && h2.componentWillReceiveProps(S2, $2), u2.__v == t5.__v || !h2.__e && null != h2.shouldComponentUpdate && false === h2.shouldComponentUpdate(S2, h2.__s, $2)) {
    ...
    if (h2.context = $2, h2.props = S2, h2.__P = n2, h2.__e = false, I2 = l.__r, A3 = 0, C3) h2.state = h2.__s, h2.__d = false, I2 && I2(u2), a2 = h2.render(h2.props, h2.state, h2.context), v.push.apply(h2.__h, h2._sb), h2._sb = [];
    else do {
      h2.__d = false, I2 && I2(u2), a2 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s;
    } while (h2.__d && ++A3 < 25);
    h2.state = h2.__s, null != h2.getChildContext && (i2 = w(w({}, i2), h2.getChildContext())), C3 && !p2 && null != h2.getSnapshotBeforeUpdate && (m2 = h2.getSnapshotBeforeUpdate(y2, _2)), H2 = null != a2 && a2.type === k && null == a2.key ? q(a2.props.children) : a2, f2 = P(n2, d(H2) ? H2 : [H2], u2, t5, i2, r2, o2, e3, f2, c4, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e3.push(h2), b && (h2.__E = h2.__ = null);
  } catch (n3) {
  ...
  else null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = B2(t5.__e, u2, t5, i2, r2, o2, e3, c4, s2);
...
function B2(u2, t5, i2, r2, o2, e3, f2, c4, s2) {
  var a2, h2, v2, y2, w2, _2, m2, b = i2.props || p, k2 = t5.props, x2 = t5.type;
  if ("svg" == x2 ? o2 = "http://www.w3.org/2000/svg" : "math" == x2 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e3) {
    for (a2 = 0; a2 < e3.length; a2++) if ((w2 = e3[a2]) && "setAttribute" in w2 == !!x2 && (x2 ? w2.localName == x2 : 3 == w2.nodeType)) {
      u2 = w2, e3[a2] = null;
      break;
    }
  }
  ...
  if (null == x2) b === k2 || c4 && u2.data == k2 || (u2.data = k2);
  else {
    if (e3 = e3 && n.call(u2.childNodes), !c4 && null != e3) for (b = {}, a2 = 0; a2 < u2.attributes.length; a2++) b[(w2 = u2.attributes[a2]).name] = w2.value;
    ...
    for (a2 in k2) w2 = k2[a2], "children" == a2 ? y2 = w2 : "dangerouslySetInnerHTML" == a2 ? h2 = w2 : "value" == a2 ? _2 = w2 : "checked" == a2 ? m2 = w2 : c4 && "function" != typeof w2 || b[a2] === w2 || F(u2, a2, w2, b[a2], o2);
    if (h2) c4 || v2 && (h2.__html == v2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t5.__k = [];
    else if (v2 && (u2.innerHTML = ""), P("template" == t5.type ? u2.content : u2, d(y2) ? y2 : [y2], t5, i2, r2, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && S(i2, 0), c4, s2), null != e3) for (a2 = e3.length; a2--; ) g(e3[a2]);
    c4 || (a2 = "value", "progress" == x2 && null == _2 ? u2.removeAttribute("value") : null != _2 && (_2 !== u2[a2] || "progress" == x2 && !_2 || "option" == x2 && _2 != b[a2]) && F(u2, a2, _2, b[a2], o2), a2 = "checked", null != m2 && m2 != u2[a2] && F(u2, a2, m2, b[a2], o2));
  }
  return u2;
}
...
var utils = {
  ...
  compute: function(t5, points, _3d) {
    ...
    if (order < 4) {
      let mt2 = mt * mt, t22 = t5 * t5, a2, b, c4, d2 = 0;
      if (order === 2) {
      ...
      const ret = {
        x: a2 * p2[0].x + b * p2[1].x + c4 * p2[2].x + d2 * p2[3].x,
        y: a2 * p2[0].y + b * p2[1].y + c4 * p2[2].y + d2 * p2[3].y,
        t: t5
      };
      if (_3d) {
        ret.z = a2 * p2[0].z + b * p2[1].z + c4 * p2[2].z + d2 * p2[3].z;
      }
      return ret;
    }
  ...
  roots: function(points, line) {
    ...
    if (order === 2) {
      const a3 = aligned[0].y, b10 = aligned[1].y, c5 = aligned[2].y, d3 = a3 - 2 * b10 + c5;
      if (d3 !== 0) {
        const m1 = -sqrt(b10 * b10 - a3 * c5), m2 = -a3 + b10, v12 = -(m1 + m2) / d3, v2 = -(-m1 + m2) / d3;
    ...
    let d2 = -pa + 3 * pb - 3 * pc + pd, a2 = 3 * pa - 6 * pb + 3 * pc, b = -3 * pa + 3 * pb, c4 = pa;
    ...
    b /= d2;
    c4 /= d2;
    const p2 = (3 * b - a2 * a2) / 3, p3 = p2 / 3, q2 = (2 * a2 * a2 * a2 - 9 * a2 * b + 27 * c4) / 27, q22 = q2 / 2, discriminant = q22 * q22 + p3 * p3 * p3;
    let u1, v1, x1, x2, x3;
    if (discriminant < 0) {
  ...
  droots: function(p2) {
    if (p2.length === 3) {
      const a2 = p2[0], b = p2[1], c4 = p2[2], d2 = a2 - 2 * b + c4;
      if (d2 !== 0) {
        const m1 = -sqrt(b * b - a2 * c4), m2 = -a2 + b, v1 = -(m1 + m2) / d2, v2 = -(-m1 + m2) / d2;
        return [v1, v2];
      } else if (b !== c4 && d2 === 0) {
  ...
  inflections: function(points) {
    ...
    const p2 = utils.align(points, { p1: points[0], p2: points.slice(-1)[0] }), a2 = p2[2].x * p2[1].y, b = p2[3].x * p2[1].y, c4 = p2[1].x * p2[2].y, d2 = p2[3].x * p2[2].y, v1 = 18 * (-3 * a2 + 2 * b + 3 * c4 - d2), v2 = 18 * (3 * a2 - b - 3 * c4), v3 = 18 * (c4 - a2);
